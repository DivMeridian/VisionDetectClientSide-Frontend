...
function AnprLivetesting() {
  ...
  return (
    <div className="relative p-6">
      ...
      <div className="relative">
        ...
        <div className="relative w-full h-[20rem] mx-auto pt-2 space-x-12">
          <div className='text-black mt-[-1rem]  flex justify-center items-center'>
            <p className="text-black text-2xl md:text-[1.5rem] xl:text-[3rem] font-semibold">ANPR Live Testing</p>
          </div>
      ...
      {/* Video Thumbnails */}
      <div className="relative flex flex-row items-center justify-center space-x-8 mt-10 xl:mt-[12rem]">
        {showOverlay && (
          <div
            id="selectVideo"
            className="fixed "
      ...
      {/* Submit Button */}
      <div className="relative z-200 flex justify-center items-center m-2 xl:mt-10">
        <button
